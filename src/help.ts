...
const ficha = (): IFicha[] => [
    ...
    { text: 'Там наверху маленькая девочка, её доверие к отцу пошатнулось, а ни одна маленькая девочка не может быть счастливой, если у нее нет веры в своего папу!', author: 'Мардж Симпсон'},
