...
const ficha = (): IFicha[] => [
    ...
    { text: 'Все мы шении. Но если вы будете судить рыбу по её способности взбираться на дерево, она проэивет всю жизнь, считая себя дурой', author: 'Альберт Эйнштейн' },
